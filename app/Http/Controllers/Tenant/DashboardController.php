...
class DashboardController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Tenant/Dashboard', [
            ...
            'overview' => [
                ['key' => 'omset', 'label' => 'Omset Hari Ini', 'value' => $this->formatRupiah($todayRevenue), 'icon' => 'fi-sr-chart-histogram', 'tone' => 'indigo'],
                ['key' => 'transaksi', 'label' => 'Transaksi Selesai', 'value' => number_format($todayTransactionCount, 0, ',', '.'), 'icon' => 'fi-sr-receipt', 'tone' => 'blue'],
                ['key' => 'produk_terjual', 'label' => 'Produk Terjual', 'value' => number_format($todayProductsSold, 0, ',', '.'), 'icon' => 'fi-sr-shopping-bag', 'tone' => 'emerald'],
                ['key' => 'produk_hampir_habis', 'label' => 'Stok Menipis', 'value' => number_format($lowStockProducts, 0, ',', '.'), 'icon' => 'fi-sr-triangle-warning', 'tone' => 'amber'],
                ['key' => 'pengeluaran', 'label' => 'Pengeluaran Hari Ini', 'value' => $this->formatRupiah($todayExpenses), 'icon' => 'fi-sr-money-bill-wave', 'tone' => 'rose'],
            ],
