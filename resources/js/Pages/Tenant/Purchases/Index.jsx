        ...
        <AdminLayout header="Pembelian">
            ...
            <div className="space-y-5">
                <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    ...
                    {can('purchases.create') && <Link href={route('tenant.purchases.create')} className="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-bold text-white shadow-sm shadow-indigo-200 transition hover:bg-indigo-700"><i className="fi fi-rr-add" /> Catat pembelian</Link>}
                </header>
