            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_320px]">
                    <main className="space-y-5">
                        ...
                        <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6"><div className="flex items-center justify-between"><div><p className="text-[10px] font-bold uppercase tracking-[0.17em] text-slate-400">Audit trail</p><h2 className="mt-1 text-xl font-black text-slate-900">Timeline tiket</h2></div><span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-bold text-slate-500">{ticket.updates.length} aktivitas</span></div>
                    ...
                    <aside className="space-y-4 xl:sticky xl:top-24 xl:self-start">
                        <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm"><div className={`${currentStatus.className} p-5`}><p className="text-[10px] font-bold uppercase tracking-[0.18em] opacity-70">Status saat ini</p><div className="mt-2 flex items-center gap-3"><span className={`h-3 w-3 rounded-full ring-4 ring-white/60 ${currentStatus.dot}`} /><p className="text-lg font-black">{currentStatus.label}</p></div></div><dl className="divide-y divide-slate-100 px-5">
