        ...
        <AdminLayout header="Sales">
            ...
            <section className="relative overflow-hidden rounded-3xl bg-slate-950 px-6 py-7 text-white shadow-xl shadow-slate-300/30 sm:px-8">
                ...
                <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                    <div><p className="text-[10px] font-bold uppercase tracking-[0.24em] text-indigo-300">Partner referral</p><h1 className="mt-2 text-3xl font-black tracking-tight">Profil sales dan kode referral.</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-slate-300">Kelola akun sales, rate komisi, dan kode referral yang mereka bagikan ke calon tenant.</p></div>
