...
const commissionLabel = (type, value) => type === 'fixed' ? money(value) : `${Number(value)}%`;
            ...
            <section className="relative overflow-hidden rounded-3xl bg-[#10251f] p-6 text-white shadow-xl shadow-emerald-950/10 sm:p-8">
                ...
                <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/5 px-5 py-4 backdrop-blur">
                        ...
                        <div className="mt-2 flex items-center gap-4"><code className="text-xl font-black tracking-[0.16em] text-[#c8f169]">{sales.referral_code}</code><span className="rounded-full bg-white/10 px-2.5 py-1 text-xs font-bold">{commissionLabel(sales.commission_type ?? 'percentage', sales.commission_type === 'fixed' ? sales.commission_value : sales.commission_rate)}</span></div>
                    </div>
                </div>
            </section>
